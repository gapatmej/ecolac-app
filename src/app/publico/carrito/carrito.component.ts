...
import {DistanciaDTO } from './../../modelos/ventas/distancia';
...
export class CarritoComponent implements OnInit{
	...
	ngOnInit(){
		...
		if(this.usuarioDTO != null){
			this.pedidoDTO.direccion = this.usuarioDTO.direccion;
			this.pedidoDTO.telefono = this.usuarioDTO.telefono;
			this.pedidoDTO.cliente = {UsuarioDTO:this.usuarioDTO};
		}
	}
